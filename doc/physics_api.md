...
can use a capsule, box, or compound collider depending on gameplay needs.

## Reusable Lights

Lighting belongs to the renderer rather than to Jolt Physics. The demo exposes
reusable Dart prototypes for directional and point lights:
...
A lamp that falls or collides needs two independent objects:
